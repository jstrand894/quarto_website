...
### PCA with Variable Category Selection
...
grid.arrange(scores.post.natrem, all.scores, ncol = 2)
...
grid.arrange(scores.pre.natrm, all.scores, ncol = 2)
```
...
grid.arrange(scores.post.hybrids, all.scores, ncol = 2)
...
grid.arrange(scores.pre.hybrids, all.scores, ncol = 2)
```

<div style="border: 3px solid #427EDC; padding: 10px; ">
