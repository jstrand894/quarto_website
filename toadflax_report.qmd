...
```{r more loading plots, echo = F}
loadings.ggplot + 
  geom_label_repel(data = loadings.plot,
                   aes(PC1, PC2, label = compound),
                   size = 4,
                   fill = "white",
                   color = "black",
...
ggsave(filename = "Toadflax PCA Scores - Type | All.png",
       plot = scores.type,
       path = "toadflax_plots/",
       width = 6,
       height = 4)
...
<a href="Toadflax PCA Scores - Type | All.png" download="TetonMountainRuns2023">
