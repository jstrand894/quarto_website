...
<div class="button-container">
  <a href="larger_boxplots.qmd">
    <button class="button">View Larger Boxplots</button>
  </a>
...
```
```{r save files1, echo = F}
ggsave(filename = "Toadflax PCA - All Type.png",
       plot = scores.type,
       path = "toadflax_plots/",
       width = 6,
       height = 4)
...
<div class="button-container">
  <a href="toadflax_plots/Toadflax PCA - All Type.png" download>
...
```
```{r save files2, echo = F}
ggsave(filename = "Toadflax PCA - Loadings Plot Basic.png",
       plot = loadings.ggplot,
       path = "toadflax_plots/",
       width = 6,
       height = 4)
```
...
<!-- Buttons to download the file -->
<div class="button-container">
  <a href="toadflax_plots/Toadflax PCA - Loadings Plot Basic.png" download>
    <button class="button">Download</button>
  </a>
...
```
<img src="toadflax_plots/loadings_with_boxes.png" alt="Toadflax PCA Loadings Plot with Box Labels" width="650"/>
...
<!-- Buttons to download the file -->
<div class="button-container">
  <a href="toadflax_plots/loadings_with_boxes.png" download>
    <button class="button">Download</button>
  </a>
...
scores.type <-
  ggplot() +
    ...
    stat_ellipse(data = model.data.all,
                 aes(PC1, PC2, color = type)) +
    labs(title = "Toadflax PCA - All Types") +
    theme_bw() +
    scale_color_manual(values = c("DT" = "#F8766D", 
                                  "Synthetic" = "#7CAE00",
                                  "YT" = "#00BFC4",
...
# for (i in 1:length(scores.type.plotly$x$data)) {
#   scores.type.plotly$x$data[[i]]$showlegend <- FALSE
# }
# use subplot to plot the two plots side by side
# subplot(scores.type.plotly, scores.post.natrem, 
#         nrows = 1, shareY = FALSE, shareX = FALSE, 
#         widths = c(0.5, 0.5)) %>%
#   layout(legend = list(title = ""))

grid.arrange(scores.post.natrem, scores.type, ncol = 2)
```
```{r save files3, echo = F}
ggsave(filename = "Toadflax PCA Scores - Type_All.png",
       plot = scores.type,
       path = "toadflax_plots/",
       width = 6,
       height = 4)
ggsave(filename = "Toadflax PCA (Post) - DT, YT, Synthetic.png",
       plot = scores.type,
       path = "toadflax_plots/",
       width = 6,
       height = 4)
...
<!-- Buttons to download the file -->
<div class="button-container">
  <a href="toadflax_plots/Toadflax_plots/Toadflax PCA (Post) - DT, YT, Synthetic.png" download>
    <button class="button">Download</button>
  </a>
...
grid.arrange(scores.pre.natrm, scores.type, ncol = 2)
```
```{r save files4, echo = F}
ggsave(filename = "Toadflax PCA (Pre) - DT, YT, Synthetic.png",
       plot = scores.pre.natrm,
       path = "toadflax_plots/",
       width = 6,
       height = 4)
```
...
<!-- Buttons to download the file -->
<div class="button-container">
  <a href="toadflax_plots/Toadflax_plots/Toadflax PCA (Pre) - DT, YT, Synthetic.png" download>
    <button class="button">Download</button>
  </a>
...
grid.arrange(scores.post.hybrids, scores.type, ncol = 2)

```
```{r save files5, echo = F}
ggsave(filename = "Toadflax PCA (Post) - Hybrids.png",
       plot = scores.post.hybrids,
       path = "toadflax_plots/",
       width = 6,
       height = 4)
```
...
<!-- Buttons to download the file -->
<div class="button-container">
  <a href="toadflax_plots/Toadflax_plots/Toadflax PCA (Post) - Hybrids.png" download>
    <button class="button">Download</button>
  </a>
...
grid.arrange(scores.post.hybrids.wold, scores.type, ncol = 2)

```
```{r save files6, echo = F}
ggsave(filename = "Toadflax PCA (Post) - Hybrids with entire.png",
       plot = scores.post.hybrids.wold,
       path = "toadflax_plots/",
       width = 6,
       height = 4)
```
...
<!-- Buttons to download the file -->
<div class="button-container">
  <a href="toadflax_plots/Toadflax PCA (Post) - Hybrids with entire.png" download>
    <button class="button">Download</button>
  </a>
...
##
var.explained <- pca.results$sdev^2 / sum(pca.results$sdev^2) * 100
formatted_variance <- format(var.explained, scientific = FALSE)
pc_names <- paste0("PC", 1:length(var.explained))
variance_table <- data.frame(PC = pc_names, var.explained = formatted_variance)

var.table <- 
variance_table %>%
  as.data.frame() %>%
  mutate(var.explained = as.numeric(var.explained)) %>%
  mutate(var.explained = round(var.explained, 2))
## 
...
grid.arrange(scores.pre.hybrids, scores.type, ncol = 2)
```
```{r save files7, echo = F}
ggsave(filename = "Toadflax PCA (Pre) - Hybrids.png",
       plot = scores.pre.hybrids,
       path = "toadflax_plots/",
       width = 6,
       height = 4)
```
...
<!-- Buttons to download the file -->
<div class="button-container">
  <a href="toadflax_plots/Toadflax PCA (Pre) - Hybrids.png" download>
    <button class="button">Download</button>
  </a>
...
meta <- data.clr %>% dplyr::select(plant, type, day)
model.data.plant <- data.frame(PC1, PC2, meta)
...
scores.plant <-
ggplot() +
  geom_point(data = model.data.plant,
  ...
  labs(x = "PC1", y = "PC2", 
       color = element_blank(),
       title = "Toadflax PCA Scores Plot by Plant") +
  stat_ellipse(data = model.data.plant,
               aes(PC1, PC2, color = plant)) +
...
```
```{r save files8, echo = F}
ggsave(filename = "Toadflax PCA - Type_Plant.png",
       plot = scores.plant,
       path = "toadflax_plots/",
       width = 6,
       height = 4)
...
<!-- Buttons to download the file -->
<div class="button-container">
  <a href="toadflax_plots/Toadflax PCA - Type_Plant.png" download>
    <button class="button">Download</button>
  </a>
...
```
```{r save files9, echo = F}
ggsave(filename = "Toadflax PCA (Post_Plant_NBR RAD).png",
       plot = scores.post.hbrrad,
       path = "toadflax_plots/",
       width = 6,
       height = 4)
```
...
<!-- Buttons to download the file -->
<div class="button-container">
  <a href="toadflax_plots/Toadflax PCA (Post_Plant_NBR RAD).png" download>
    <button class="button">Download</button>
  </a>
...
grid.arrange(scores.pre.hbrrad, scores.plant, ncol = 2)
```
```{r save files10, echo = F}
ggsave(filename = "Toadflax PCA (Pre_Plant_NBR RAD).png",
       plot = scores.pre.hbrrad ,
       path = "toadflax_plots/",
       width = 6,
       height = 4)
```
...
<!-- Buttons to download the file -->
<div class="button-container">
  <a href="toadflax_plots/Toadflax PCA (Pre_Plant_NBR RAD).png" download>
    <button class="button">Download</button>
  </a>
